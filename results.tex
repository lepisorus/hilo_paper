...
Since the Mexican and Andean highlands are around 4,000 km apart, the time needed for a rare allele with weak selective cost $s_m=10^{-4}$ in the lowlands to transit between the two highland regions is $\Tmig \approx 2 \times 10^{7}$ generations. 
...
then $\Tmig \approx 2$ generations,
...
with the still weak selective cost of $s_m=10^{-3}$, for example, $\Tmig$ is $2.5 \times 10^4$ generations over 1,000km,
and much larger for longer distances.
\plr{fixed this up: removed factor of $2s_b/\xi^2$ in the R code that doesn't appear in \eqref{eqn:migrate}.}
