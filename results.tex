...
%Shoh: please modify/add a sentence or two here on empirical results on standing var. We also need a sentence or two here on why we expect this based on theory. I think we drop the domestication comparison
...
% 2) We do see evidence of selection on other SNPs, suggesting that even if there are hard sweeps we missed, a substantial amount of selection on standing var occured.
% 3) The number of hard sweeps couldn't have been huge
