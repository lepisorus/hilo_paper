...
The proportion of putatively adaptive SNPs in introgressed regions of the genome in highland maize from Mexico is significantly higher than found in highland maize in S. America (FET $P<10^{-6}$). 
Outside introgressed regions, the proportion of significant SNPs showed much less marked differences (FET, $P=0.036$).
