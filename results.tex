...
\begin{figure}[tb]   
  \begin{center}
   ...
   Red, blue, orange and gray dots represents SNPs showing significance in both Mesoamerica and S. America, only in Mesoamerica, only in S. America, respectively (see text for details).
...
To test this hypothesis, we sought to identify the adaptive allele at each locus using comparisons between Mesoamerica and S. America as well as to \emph{parviglumis} (Supporting Information, File S1).  
...
SNPs were consistent with Mesoamerica-specific adaptation if one allele was at high frequency in one Mesoamerican population,
low frequency in the other Mesoamerican population,
...
show that even neutral alleles are not expected to transit between the Mesoamerican and Andean highlands within 4,000 generations.
%\plr{is that the right amount of time?}
%\jri{yes: arrive in highlands of andes 4Kya, so there could be 4K gens or migration to have brought allele}
...
that are shared by both the Mesoamerican and S. American highlands
...
leading us to evaluate the contribution of introgression  from \textit{mexicana} \citet{Profford_2013} in patterning differences between S. American and Mesoamerican highlands.  
