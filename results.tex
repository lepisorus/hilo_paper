...
We identified 687 SNPs in Mexico (687/76,989=0.89\%) and 409 SNPs in South America (409/63,160=0.65\%) as significant outliers (Figure~\ref{PvDist}) for differentiation between lowland and highland populations ($P<0.01$).
Outlier SNPs were enriched in intergenic regions rather than protein coding regions (60.0\% vs. 47.9\%, Fisher's Exact Test $P < 10^{-7}$ for Mexico; 62.0\% vs. 47.8\%, FET $P<10^{-5}$ for S. America).
...
The area of the Andean highlands is around $A=500\text{km}^2$ \mbh{this area seems way too small}, leading to a total population of $A \rho = 2.5 \times 10^6$. 
...
\mbh{So is this looking at standing variation from the Mexican and South American lowlands separately or as a joint lowland group?  Are adaptive SNPs from Mexico and South America segregating in both lowland groups?  If so, has adaptation in the two regions just involved selection on largely different subsets of potentially adaptive loci?}
