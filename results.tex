...
%
%I vote to delete the above commented out section. we do the correction, so no need to say it's a small effect if we don't do it is there?
...
%I think we drop the domestication comparison, and instead work with other caes of recent adaptation? We also need a sentence or two here on why we expect this based on theory.
