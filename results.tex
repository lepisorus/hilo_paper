...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% FIGURE
%
\jri{there is one obvious shared red SNP that is an outlier. what gene is it in? what does that gene do? anything we want to mention in the discussion? I suspect a reviewer will ask.}
