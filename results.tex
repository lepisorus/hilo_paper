...
We chose $P<0.01$ as an arbitrary cut-off for significant differentiation between lowland and highland populations, and identified 687 SNPs in Mexico (687/76,989=0.89\%) and 409 SNPs in South America (409/63,160=0.65\%) as outliers (Figure~\ref{PvDist}). \jri{Can we add a sentence here saying "Different cutoff values used gave qualitatively identical results"? I believe you did that analysis already and it's ok to say that, right?}
...
An alternative process that could generate patterns of shared adaptive SNPs is gene flow between highland regions.
