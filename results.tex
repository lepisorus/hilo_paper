...
then the same allele would be expected to transit between populations in approximately 2 generations 
\mbh{is this correct?  4000km in $\approx 4 \times 10^{10}$ and 1000km in 2 generations?}.
...
We found that putatively adaptive variants identified in both Mexico and S. America tended to segregate in the lowland population more often than other SNPs of similar mean allele frequency (85.3\% vs. 74.8\% in Mexico, FET {$P < 10^{-9}$ and 94.8\% vs 87.4\% in S. America,  $P< 10^{-4}$).  
...
Again we found that putatively adaptive variants were more likely to be polymorphic in \emph{parviglumis} (78.3\% vs. 72.2\% in Mexico, FET {$P < 0.01$ and 80.2\% vs 72.8\% in S. America,  $P< 0.01$). 
