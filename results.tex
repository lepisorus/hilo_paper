...
%MBH: Not sure what happened to the end of the previous sentence.
...
%MBH:  So my read of this is that 95 GUs had a SNP with the same allele at high frequency in the highlands of both SA and Mexico (parallel adaptation) and 12 of these had one SNP in a GU significant in Mexico and another in the same GU significant in South America (also parallel adaptation if you assume the SNPs result in the same phenotype)
