...
%\jri{Sho do you have numbers on how many of the introgressed regions identified by Matt have $\ge 1$ adaptive SNP here in each pop? Or what \% of our adaptive SNPs are in introgressed regions in each pop? Some way of quantifying how much overlap there is, like we do above for Tanja's SNPs. Would be good for SNPs and genes.  In the .tex it says "77/473 (16.3\%) and 14/274 (5.1\%)  GUs of Mexico- and SA-specific significance in introgressed regions (Fisher's exact test, $P<10^{-6}$)" are those numbers still good? that might help the comparison in the previous sentence too, since even a FET of 0.036 is still statiscally signficant, isn't it?}
%\st{Reply to JRI via e-mail.}

The proportion of putatively adaptive SNPs in introgressed regions of the genome in highland maize from Mexico is nearly four times higher than found in highland maize in S. America (FET $P<10^{-11}$). 
Outside introgressed regions, the proportion of significant SNPs showed much smaller differences (7.5\% vs. 6.2\%; Table \ref{supp:introgressed}).
