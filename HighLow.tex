...
as it grows across an altitudinal gradient (rather than an abrubt transition) and has high variance in number of offspring.
...
\plr{Doesn't ``rapid decay'' make you less worried about hitchhiking, rather than more? or am I misreading?}
