...
\abstract{
\st{\bf{NOTE: Revised texts are highlighted in red for the editor and reviewers!!}}
\st{Convergent evolution is the independent evolution of similar traits in species of different lineages.
As a consequence, multiple species/subpopulations sometimes adapt to similar environments via similar phenotypes; we refer to this process as \textit{convergent adaptation}. }
