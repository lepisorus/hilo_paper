...
Evolutonary genetic analysis of wide range of species have provided evidence for multiple pathways to parallel adaptation. 
One route to parallel adaptaiton, for example, occurs when identical beneficial mutations arise and fix via natural selection independently in multiple populations. 
In humans, for example, malaria resistance due to mutations from Glu to Val at the sixth codon of the $\beta$-globin gene have arisen independently on multiple unique haplotypes  \cite[]{Currat_2002_11741197,Kwiatkowski_2005_16001361}.  
We may also consider as parallel adaptation cases in which different mutations arise within the same locus, producing identical phenotypic effects. 
...
Finally, parallel adaptation may arise from natural selection in independent populations acting on standing genetic variation in the ancestral population.  
Natural selection in multiple threespine sticklebacks, for example, has repeatedly acted to reduce armor plating during colonizations of freshwater environments.  
In most cases, adaptation in these populations took advantage of standing variation at the \emph{XXXXXXX} locus in marine populations \cite[]{Colosimo_2005_15790847}.  
% are there more we are missing and should mention?
iWhile these examples of single-locus selection are relatively simple, in reality an organism must adapt to a number of abiotic and biotic conditions and the genetic architecture of adaptive phenotypes may be complex.  
...
Motivated by these questions we sought to investigate the molecular basis of parallel adaptation to highland conditions in domesticated maize (\emph{Zea mays} ssp. \emph{mays}).  
Maize was domesticated from the wild teosinte \emph{Zea mays} ssp. \emph{parviglumis} in the lowlands of southwest Mexico $\sim$9,000 years before present (BP) \cite[]{Matsuoka_2002_11983901,Piperno_2009_19307570,vanHeerwaarden_2011_21189301}. 
...
Colonization of high altitude environments provides a host of novel challenges, including different temperatures, precipitation, ultraviolet radiation, and hypoxia. 
