...
Therefore, we used the following more detailed demographic model (following \citet{joost}) 
...
\plr{peter: well, neutral is do-able\dots}

Paragraph on rough parameter values.
A figure? Or just a table?  What seems most useful?
