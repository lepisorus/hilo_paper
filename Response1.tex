...
\response{
    ...
    Also note the \plr{XXX add} section of the Discussion about shared standing variation in founder populations.
}
...
\response{
  Great points. See previous note, and our additions to the Discussion. \plr{XXX add}
}
