...
\response{
Even if a variant is adaptive and in the standing variation, there is no guarantee it will be selected in both populations.  For a detailed analysis, see Ralph and Coop 2015 (http://dx.doi.org/10.1101/009803). We also note that we see a similar lack of convergence regardless of the p-value cutoff we used, suggesting our result is unlikely due to the proportion of false positives in our outlier SNPs.  Please also see our response to the above comments as for biological significance.
}
