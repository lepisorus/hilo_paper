...
The resulting values of $\mutrate$ and $\migrate$ depend most strongly on the population density, the selection coefficient, and the rate at which seed is transported long distances and replanted; \jri{add text about how likely this is, cite JvH and empriical estimates}
...
\plr{Correct for diploidy.}
\plr{Add note that this is $N_e/N$, for reviewer 1.}
...
\plr{Analysis of selection model in appendix.}
