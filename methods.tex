...
%
% You mean supp table?  I don't know how to refer to a table in a different tex file. - ST
% That's the cool thing, you just use the lable like any table, as these all end up in the main file!
...
This array contains SNPs discovered in five ascertainment schemes \cite[]{Ganal_2011_22174790}; however, the vast majority of SNPs come from two panels: the Syngenta set (14,810 SNPs), derived from polymorphisms distinguishing the parents of the IBM mapping population (the maize lines B73 and Mo17), and the Panzea set, including 40,594 SNPs identified during sequencing of the 25 parents of the NAM population.  
