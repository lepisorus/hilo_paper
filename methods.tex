...
A subset of silent \jri{would it be correct to change "silent" to say "synonymous and noncoding"?}\st{ok} SNPs were utilized that had $\geq15$ individuals without missing data in both low- and highland populations and did not violate HWE.  
...
The \emph{P}-values of a SNP was calculated by $P(F_{ST\_E}\geq F_{ST\_O}|p\pm 0.05) = P(F_{ST\_E}\geq F_{ST\_O} \cap p\pm 0.05)/P(p\pm 0.05)$, 
