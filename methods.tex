...
is assumed to be $(1+s)$ times larger for individuals heterozygous for the selected allele.
...
except that heterozygotes have on average $(1+s)$ offspring that carry the selected allele.
