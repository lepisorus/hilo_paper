...
\jri{can we just remove the phrase and leave the result w/o the data to back it up?}
...
\plr{Perhaps a brief sentence saying didn't do a four population model because inference becomes slow and unreliable with so many parameters.} \jri{dadi can only do 3 pops i thought}
