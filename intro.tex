...
%MBH: I've smoothed it in a bit.  I think it works
...
%MBH: Kind of a rough transition here to the next paragraph, but maybe that's o.k.
...
%MBH: "reduced partial pressure of atmospheric gases" is more correct (and way wordier which makes me ever so much more happy)
...
%MBH:  I think the review I've cited covers all the bases and also provides caveats as to why these trends are not universal.
...
%
Common garden experiments in Mexico reveal that highland maize has successfully adapted to highland conditions \cite[]{Mercer2008}, and phenotypic comparisons between Mexican and South American populations are suggestive of parallel adaptation.  Landraces from both populations share a number of phenotypes not found in lowland populations, including dense macrohairs \cite[]{CITE}, stem pigmentation \cite[]{CITE}, and biochemical response to UV radiation \cite[]{Casati2005}.
%
% Matt please fill in if there are other features you're aware of. 
%MBH:  I think these are sufficient
...
In this paper we set out to address a number of questions regarding highland adaptation in maize: What is the genetic architecture of highland adaptation? Do maize populations in South America show evidence of parallel adaptation when compared with highland maize from Mexico? 
