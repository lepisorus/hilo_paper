...
\comst{move this to the main text}
\st{Finally, we asked whether the PHS test supports highland and lowland adaptation scenario (summarized in Table~\ref{supp:phs}).
