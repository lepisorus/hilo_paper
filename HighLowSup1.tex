...
{\fontsize{8}{11}\sf
   ...
   S. America & Highland adaptation & 164 & 230 (71.3\%) &  $P<10^{-5}$  \\
    ...
    \hline\hline
    \multicolumn{5}{l}{\st{$^a$ Association between haplotype length and adaptive signals by $F_{ST}$ analysis (need better phrase!!).  See Supporting File S1 for details.}}\\
    \end{tabular}
