...
\subsection*{Directionality of adaptation}
...
\subsection*{Details of the demographic model}
...
{\fontsize{8}{11}\sf
  ...
  & $\sigma$ & 1\\
      \hline
    & & \\[-3mm]
    South America  & \multicolumn{2}{c}{Model IA}  \\[0.1cm]
        \hline
    & & \\[-3mm]
     & Likelihood &  $-$2717.64  \\
       &$\alpha$ & 0.51 \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%=
\begin{table}	
	\caption{$F_{ST}$ outlier SNPs and \emph{mexicana} introgression} 
			\centering
			\textbf{}\\[-2mm]
			{\fontsize{8}{11}\sf
