...
{\fontsize{8}{11}\sf
    \begin{tabular}{lllllcccccl} \hline\hline
       & & \\[-3mm]
     Population  & Pattern of adaptation & No. of SNPs & No. of SNPs supported by PHS test & {Significance $^a$} \\[0.1cm]
    \hline
    & & \\[-3mm]
   ...
   S. America & Highland adaptation & 164 & 230 (71.3\%) &  $P<10^{-5}$  \\
    ...
    \hline\hline
    \multicolumn{5}{l}{{$^a$ Probability of the observed percent of SNPs showing a lower empirical quantile. Under neutrality, 50\% of SNPs}}\\
     \multicolumn{5}{l}{{ should have lower PHS values in the focal population; higher values indicate evidence of selection.  See the main }}\\
      \multicolumn{5}{l}{{ text for details.  }}\\
    \end{tabular}
