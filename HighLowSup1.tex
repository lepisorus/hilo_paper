...
\begin{table}[htb!!]
  ...
  \begin{tabular}{|cll|}
    ...
    area of highland habitat             & $A$        & 270,000 km$^2$ \\
...
\begin{center}
 \caption[]{Patterns of adaptation\hspace*{9.1cm}}
  \textbf{}\\[-2mm]
{\fontsize{8}{11}\sf
    \begin{tabular}{lllllcccccl} \hline\hline
       & & \\[-3mm]
     Population  & Pattern of adaptation & No. of SNPs & No. of SNPs supported by PHS test & \rev{Significance $^a$} \\[0.1cm]
    \hline
    & & \\[-3mm]
   ...
   S. America & Highland adaptation & 164 & 230 (71.3\%) &  $P<10^{-5}$  \\
    ...
    \hline\hline
    \multicolumn{5}{l}{\rev{$^a$ Probability of the observed percent of SNPs showing a lower empirical quantile. Under neutrality, 50\% of SNPs}}\\
     \multicolumn{5}{l}{\rev{ should have lower PHS values in the focal population; higher values indicate evidence of selection.  See the main }}\\
      \multicolumn{5}{l}{\rev{ text for details.  }}\\
    \end{tabular}
...
\begin{figure}[h]
  \begin{center}
    ...
    \caption{Pattern of decay of linkage disequilibrium in Mesoamerica (A) and S. America (B).  Red and blue dots represent lowland and highland populations, respectively.  $r^2$ values are reported as averages within 10-bp distance bins. }
    \label{supp:LD}
  \end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
