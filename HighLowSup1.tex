...
{\fontsize{8}{11}\sf
   ...
   S. America & Highland adaptation & 164 & 230 (71.3\%) &  $P<10^{-5}$  \\
    ...
    \hline\hline
    \multicolumn{5}{l}{\st{$^a$ Association between haplotype length and adaptive signals by $F_{ST}$ analysis.  See Supporting File S1 for details.}}\\
    \end{tabular}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%=
\begin{table}[h]	
	\caption[]{\st{List of metabolic pathways with the evidence of convergent adaptation}\hspace*{0.3cm}} 
			\centering
			\textbf{}\\[-2mm]
			{\fontsize{7}{11}\sf
